  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-4 space-y-8 animate-in fade-in duration-500">
      <div className="space-y-4 text-center">
        ...
        <h1 className="text-5xl font-headline font-bold text-foreground">Impact Audit</h1>
      ...
      <Card className="glass-card border-none overflow-hidden shadow-2xl">
        <CardHeader className="bg-primary/5 border-b border-black/5 py-8 px-10">
        ...
        <CardContent className="p-10 min-h-[400px]">
          ...
          {currentStep === 2 && (
            <div className="space-y-8 max-w-xl mx-auto">
              <Label className="text-xl font-bold text-center block text-foreground">Select your primary diet profile</Label>
          ...
          {currentStep === 3 && (
            <div className="space-y-12 max-w-xl mx-auto">
               <div className="space-y-6">
                <Label className="text-lg font-bold text-foreground">Shopping Frequency</Label>
               ...
               <div className="space-y-6">
                <Label className="text-lg font-bold text-foreground">Waste Production</Label>
          ...
          {currentStep === 4 && (
            <div className="text-center space-y-8 py-12 animate-in zoom-in duration-500">
               ...
               <div className="space-y-2">
                 <h2 className="text-4xl font-headline font-bold text-foreground">Audit Complete</h2>
               ...
               <div className="flex items-center justify-center gap-6 py-4">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-3xl font-headline font-bold text-foreground">Verified</p>
                  </div>
               </div>
